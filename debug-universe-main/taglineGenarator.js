...
document
  ...
  Object.keys(addEventListener('click',function (e){
    this.document.createElement('div').innerHTML = `<p> I am web developer </p> <b>Now i can make websites for my clients</b> `
  }))
